...
/**
 * Decrement a numeric field's value
 */
lastStepModifierFunctions.$dec = function (obj, field, value) {
  if (typeof value !== 'number') { throw value + " must be a number"; }
  ...
  if (typeof obj[field] !== 'number') {
    if (!_.has(obj, field)) {
      ...
      throw "Don't use the $dec modifier on non-number fields";
    }
  } else {
    obj[field] -= value;
  }
...
lastStepModifierFunctions.$max = function (obj, field, value) {
  ...
  if (typeof obj[field] !== 'number') {
    if (!_.has(obj, field)) {
      ...
      throw "Don't use the $max modifier on non-number fields";
    }
  } else {
    if (value > obj[field])
      obj[field] = value;
...
lastStepModifierFunctions.$min = function (obj, field, value) {
  ...
  if (typeof obj[field] !== 'number') {
    if (!_.has(obj, field)) {
      ...
      throw "Don't use the $min modifier on non-number fields";
    }
  } else {
    if (value < obj[field])
      obj[field] = value;
